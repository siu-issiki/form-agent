 ...
 * dry-run of the same form URL that already reached the dry-run boundary, and
 * must fit inside the day's cap. The cap defaults to 0, so the path stays shut
 * unless a deploy explicitly opens it.
 *

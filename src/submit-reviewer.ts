...
export const SUBMIT_REVIEW_INSTRUCTIONS = [
	...
	"Determine the form purpose from explicit form-specific notices, then compare that purpose with the actual subject and message in formValues. A general CONTACT or お問い合わせ form with ordinary inquiry instructions and no stated scope restriction is compatible with an event invitation or business introduction. Do not require an explicit welcome for invitations or all topics, and do not invent a restriction merely because the message promotes something rather than asking a question about the recipient.",
	'A notice such as "弊社サービスへのお問い合わせはこちらからご連絡ください", "当社サービスに関するお問い合わせ", or "サービスにご興味をいただきありがとうございます" scopes the form to questions or requests about the services offered by the recipient. Deny unrelated sales pitches or event invitations with FORM_PURPOSE_INCOMPATIBLE, even without an explicit sales prohibition. An "other" option within that service context does not alone authorize unrelated outreach.',
	...
	"Descriptions of the company business or services in navigation, a footer, or elsewhere outside the form-specific notice are not a service-only form restriction. General inquiry wording by itself is not a sales prohibition. Keep denying explicit sales prohibitions and actual dedicated-purpose forms; a generic contact heading does not override a specific scope restriction.",
